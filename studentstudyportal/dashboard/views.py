    ...
    if request.method == "POST":
        ...
        for i in range(10):
            result_dict = {
                ...
                'count':answer['title'][i]['volumeInfo'].get('pageCount'),
                'categories':answer['title'][i]['volumeInfo'].get('categories'),
                'rating':answer['title'][i]['volumeInfo'].get('pageRating'),
                'thumbnail':answer['title'][i]['volumeInfo'].get('imageLinks').get('thumbnail'),
...
def dictionary(request):
    if request.method == "POST":
        ...
        return render(request,"dashboard/dictionary.html",coontext)
